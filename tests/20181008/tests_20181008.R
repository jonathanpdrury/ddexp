...
for(i in 1:dim(simdata)[1]){
		...
		o3B<-fit_t_general(regime.simmap.region.trimmed, M, fun=new_list_function,diagnostic=T,echo=T,constraint=FALSE,method="BB")				 
		}
		...
		print(int)
		print(i)
		write.csv(res.mat,file="ddm_simulation_study_20181009.csv")
	}	
