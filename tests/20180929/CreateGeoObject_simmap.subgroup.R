##this function returns a geo.object that has set lineages NOT in a subgroup to "allopatric" for case of sympatric subgroup trimming

CreateGeoObject_simmap.subgroup<-function(simmap,trim.class,rnd=5){
...
geo.object<-CreateGeoObject(new.map,new.map)
