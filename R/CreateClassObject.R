#This is a  script that creates a class object which lists states for each branch at each point in time
#The inputs are:
#map (map object that is a stochastic map of discrete traits used to identify guild of competitors)
#both.category (ignore for now, could be modified to allow overlap between categories)
